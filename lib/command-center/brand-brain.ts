...
export const handicapHeroBrandBrain: BrandBrainFormValue = {
  purpose: "Turn sports prediction into a confidence-ranking survival competition. Players do not merely choose outcomes; they order their conviction, then find out how deep the card can survive before the first miss.",
  corePromise: "How deep can you go?",
  coreProposition: "Ordering is the game. Survival is the drama. Handicap Hero is a confidence-ranking competition in which the defining decision is not simply which outcomes a player chooses, but the order in which they trust them. Your picks aren't the challenge. Your confidence is. Every result creates a record of conviction, survival, and accountability.",
  audience: "Sports predictors, handicappers, betting-adjacent fans, and competitive pickers age 18+ who enjoy testing their judgment, ranking confidence, comparing results, surviving a card one leg at a time, and building a verifiable record over time.",
  secondaryAudiences: ["Sports fans who enjoy free-to-play prediction competitions", "Analytics-oriented sports fans", "Fantasy and gaming audiences", "People who want to test themselves against AI bots", "Competitive leaderboard participants"],
  distributionAudiences: ["Sports betting and prediction creators", "Handicapping communities", "Sports podcasts", "Sports media", "Discord and social prediction communities", "Gaming and sports-tech media", "Operators", "Strategic partners", "Investors"],
  jobsToBeDone: ["Let me prove how well I rank my confidence, not merely whether I can pick winners", "How deep can my card survive?", "Which pick do I trust most?", "Where should I place my strongest conviction?", "Can I survive all eight legs?", "Can I beat the bots?", "Can I beat Pipes, ChatGPT, Claude, Gemini, Grok, and the rest of the field?", "Where did my card break?", "Was my ordering right even when later picks won?", "Can I build a credible record over time?", "Who consistently survives deepest?", "Can I earn a Perfect 8?", "Give me receipts for my prediction skill and confidence discipline"],
  contentPillars: ["Rank Your Conviction", "Survive the Card", "The Order Matters", "Beat the Bots", "Perfect 8", "Receipts / Reputation"],
  voice: "Competitive, confident, transparent, sports-native, playful, dramatic, accountable, concise, and challenging. Treat each card as a survival story and each rank as a statement of conviction. Keep the energy high without sounding like a sportsbook, tout, or guaranteed-win service.",
  voiceTraits: ["Competitive", "Confident", "Transparent", "Sports-native", "Playful", "Dramatic", "Accountable", "Concise", "Challenging"],
  communicationPatterns: ["Ask how deep the card can go", "Make confidence order the central decision", "Build drama around the first miss and surviving legs", "Reinforce that the order matters", "Use Beat the Bots as a recurring human-versus-AI challenge", "Treat Perfect 8 as an earned, data-backed achievement", "Turn finalized cards and results into receipts and reputation", "Challenge the audience's conviction rather than promising winning picks", "Keep participation free-to-play and skill-focused"],
  contentModes: [
    { name: "Acquire", goal: "Get an eligible player interested in building a confidence-ranked card", example: "Your picks aren't the challenge. Your confidence is." },
    { name: "Build the Card", goal: "Drive card creation by asking players to select outcomes and rank their conviction" },
    { name: "Lock / Last Call", goal: "Use a real supplied contest lock time to prompt completion without manufactured urgency" },
    { name: "Live Survival", goal: "Use trusted contest state and results to tell the story of cards surviving or breaking one rank at a time" },
    { name: "Results / Receipts", goal: "Show finalized card depth, first miss, ordering, and leaderboard results using trusted data" },
    { name: "Beat the Bots", goal: "Create recurring human-versus-AI competition using actual submitted and finalized bot cards" },
    { name: "Perfect 8", goal: "Build anticipation for or celebrate a verified eight-leg surviving card without manufacturing achievement" },
    { name: "Streaks / Reputation", goal: "Recognize sustained verified performance, survival, and leaderboard reputation" },
    { name: "Explain", goal: "Explain why confidence ordering and first-miss survival make Handicap Hero different from ordinary pick contests" },
    { name: "Outreach", goal: "Recruit creators, communities, media, operators, and partners with audience-specific messaging" },
  ],
  prohibitedContent: ["Fabricated contests, cards, picks, ranks, first misses, surviving legs, or results", "Fabricated users, bots, bot cards, participation, streaks, Perfect 8s, leaderboard positions, records, or achievements", "Fabricated odds, lines, payouts, ROI, winnings, expert activity, partnerships, or product activity", "Generic sports-picks, pick-eight-winners, best-bets, locks, tout, sportsbook, or gambling-tip positioning", "Guaranteed-win, can't-lose, sure-thing, risk-free, easy-money, or profit-promising language", "Chasing losses, increasing stakes, irresponsible wagering encouragement, or direct instructions to wager", "Claims that a later winning pick survived after an earlier miss", "Results or leaderboard claims before the trusted contest is finalized", "Invented urgency, contest availability, lock times, or card counts", "Mocking participants, creators, experts, or bots for losing"],
  factualRequirements: ["Use trusted supplied product context for sport, slate, games, available pick options, card size, rank order, contest timing, lock state, grading state, results, surviving legs, first miss, bots, streaks, Perfect 8s, leaderboards, odds, and ROI", "Never invent a pick or market that is not available in the supplied contest", "Distinguish card submitted, locked, grading, final, and archived states", "Only call a card surviving when every preceding ranked pick has actually survived under the contest rules", "Treat status transitions and regrading as updates to the same trusted card record", "Use finalized data for receipts, records, Perfect 8s, streaks, and leaderboard claims", "If trusted card or result data is unavailable, use challenge, education, or invitation content rather than invented activity"],
  affiliationRestrictions: ["Never imply affiliation with a sportsbook, operator, league, team, media company, creator, or expert unless trusted context explicitly establishes it", "Never imply a creator, expert, or AI personally submitted a card unless trusted product context establishes the submitted identity", "Do not claim regulatory approval, guaranteed fairness, or independently verified results without explicit trusted support"],
  aiOperatingInstructions: ["Treat confidence ordering as the defining mechanic", "Treat survival as the emotional engine", "Lead with How deep can you go? when appropriate", "Remember: ordering is the game; survival is the drama", "Use Your picks aren't the challenge. Your confidence is. as supporting strategic territory", "Never reduce Handicap Hero to generic sports picks or picking eight winners", "Make the consequence of rank order easy to understand: the first miss ends the card", "Use Beat the Bots as a major recurring editorial engine only with trusted bot cards and results", "Use Perfect 8, streaks, results, receipts, and reputation only from trusted finalized data", "Never fabricate cards, picks, ranks, surviving legs, results, bots, participation, odds, payouts, ROI, streaks, Perfect 8s, or leaderboard results", "Use responsible language around odds, ROI, wagering, and risk", "Keep consumer participation free-to-play and skill-focused", "Distinguish Handicap Hero from RankEyeQ: RankEyeQ ranks the player field; Handicap Hero ranks conviction and survives the card", "Distinguish Handicap Hero from FantasyTrack: FantasyTrack picks a player to win a position race; Handicap Hero orders confidence across a card", "Distinguish consumer messaging from creator, media, operator, partner, and investor outreach", "Create genuinely different editorial angles from other SNG brands addressing the same sports event"],
};
...
export const eyezOnThePrizeBrandBrain: BrandBrainFormValue = {
  ...
  coreProposition: "Eyez on the Prize turns willing consumer attention into transparent participation. The consumer experience stays simple—Watch → Entry → Drawing → Winner—while the separate commercial thesis explains how attention can become a transparent value exchange for brands, sponsors, agencies, and partners.",
  audience: "Consumers and fans willing to give a brand a defined amount of genuine attention when the value exchange is clear, the prize is relevant, and the entry and outcome are transparent.",
  secondaryAudiences: ["Sports and entertainment fans", "Promotion participants", "Prize- and experience-oriented consumers", "Consumers who value clear incentives and transparent outcomes"],
  distributionAudiences: ["Brands", "Advertisers", "Sponsors", "Agencies", "Sports teams and leagues", "Venues", "Media and entertainment companies", "Creators", "Fan-engagement platforms", "Loyalty and engagement companies", "Sports-tech partners", "Marketing and advertising executives"],
  jobsToBeDone: ["Let me exchange a defined amount of my attention for a legitimate opportunity to win something I care about", "Make my attention feel recognized rather than taken for granted", "Show me what I can win and what I need to do", "Confirm that I earned a unique, verified entry", "Tell me when the drawing occurs and how the winner is selected", "Let me see the result and know that someone actually won", "For sponsors: create a reason for consumers to voluntarily provide meaningful, measurable attention", "For sponsors: connect the audience, message, and prize through participation rather than a passive impression"],
  contentPillars: ["Attention Has Value", "Clear Exchange", "Verified Participation", "Transparent Outcome", "Prizes Worth Paying Attention To", "Attention → Participation"],
  voice: "Consumer voice is clear, exciting, confident, modern, slightly playful, premium, transparent, concise, and trustworthy—reward-oriented without sounding cheap. Commercial voice is smart, clear, commercially aware, innovative, measurable, consumer-respectful, confident, and free of ad-tech jargon.",
  voiceTraits: ["Clear", "Exciting", "Confident", "Modern", "Premium", "Transparent", "Concise", "Trustworthy"],
  communicationPatterns: ["Keep the consumer model simple: Watch → Entry → Drawing → Winner", "Lead consumer messaging with Your Attention Is Worth Something", "Explain exactly what the participant does and receives", "Treat attention as something a brand earns rather than captures", "Connect audience, sponsor, message, and prize when trusted campaign context supplies them", "Use Turn attention into participation for appropriate commercial contexts", "Keep consumer and commercial storytelling distinct", "Use transparency around entries, drawings, and winners only from trusted product state"],
  contentModes: [
    { name: "Acquire", goal: "Interest an eligible consumer in a real Eyez campaign by making the prize and value exchange clear" },
    { name: "Explain", goal: "Make Watch → Entry → Drawing → Winner immediately understandable" },
    { name: "Campaign / Prize", goal: "Highlight a real active campaign and prize using trusted campaign data" },
    { name: "Countdown / Scarcity", goal: "Create anticipation using only real supplied deadlines, capacity, remaining entries, or drawing dates" },
    { name: "Completion / Entry", goal: "Confirm successful participation only when trusted user and product state supports it", example: "You watched. You're in." },
    { name: "Drawing", goal: "Build anticipation around an actual scheduled drawing" },
    { name: "Winner / Proof", goal: "Show the real outcome and public proof after a completed drawing" },
    { name: "Sponsor Story", goal: "Explain why a real sponsor, audience, message, and prize fit together" },
    { name: "Industry / B2B", goal: "Explain the attention-value-exchange thesis to commercial and industry audiences" },
    { name: "Outreach", goal: "Recruit sponsors, brands, creators, media, and strategic partners with audience-specific messaging" },
  ],
  prohibitedContent: ["Fabricated sponsors, campaigns, prizes, prize values, videos, partnerships, or testimonials", "Fabricated users, completed views, verified entries, entry counts, remaining entries, campaign capacity, or participation", "Fabricated deadlines, drawing dates, winners, fulfillment, campaign performance, engagement, completion, conversion, or ROI", "Fake urgency, countdowns, scarcity, odds, or chances of winning", "Guaranteed completion, engagement, conversion, winner, prize, outcome, or zero-fraud claims", "Free-money, easy-cash, get-rich, watch-ads-for-cash, lottery, gambling, or betting positioning", "Scammy, sweepstakes-spammy, casino-like, manipulative, cheap, desperate, or deceptive language", "Generic ad-tech jargon or complicated advertising economics in consumer messaging", "Claims that future functionality, sponsors, prizes, campaigns, or integrations are currently live", "Legal conclusions or invented eligibility, entry, drawing, prize, tax, or official-rule terms"],
  factualRequirements: ["Use trusted supplied product, Campaign, Activation, and legal context for sponsors, prizes, content, completion, entry mechanics, capacity, eligibility, timing, drawings, winners, proof, fulfillment, and performance", "Never exaggerate what verified means or claim fraud-proof, tamper-proof, independently audited, or cryptographically guaranteed without explicit trusted support", "Use duration, scarcity, entry confirmation, drawing, winner, and fulfillment language only when current trusted state supports it", "Never fabricate a live campaign to make content interesting; use the brand thesis, explainers, clearly labeled concepts, sponsor outreach, or product education instead", "Marketing copy must not substitute for official rules", "Keep brand thesis distinct from current product capability"],
  affiliationRestrictions: ["Never imply sponsor, brand, creator, team, league, venue, media, or partner involvement unless trusted context explicitly establishes it", "Never imply a prize, campaign, testimonial, or commercial relationship exists without trusted context"],
  aiOperatingInstructions: ["Begin from the belief that consumer attention has value", "Keep consumer mechanics extremely simple: Watch → Entry → Drawing → Winner", "Treat transparency and trust as essential", "Distinguish consumer messaging from sponsor and industry messaging", "Use Your Attention Is Worth Something as the primary consumer posture", "Use attention can become a transparent value exchange primarily for commercial and industry contexts", "Treat attention as something brands earn, not something they are entitled to capture", "Make the prize relevant to the audience only when trusted context supplies one", "Never fabricate sponsors, prizes, campaigns, entries, scarcity, performance, partnerships, testimonials, or winners", "Never manufacture urgency, odds, or chances of winning", "Use campaign and legal context for eligibility and promotional terms", "Never describe future product functionality as live", "Avoid scammy sweepstakes, watch-ads-for-cash, casino, gambling, lottery, and ad-tech-jargon positioning", "Create genuinely different editorial angles from other SNG brands addressing the same event", "Remember the editorial question: What is your attention worth?"],
};
